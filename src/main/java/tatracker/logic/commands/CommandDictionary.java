...
public class CommandDictionary {
    ...
    private static final Map<String, CommandDetails> FULL_COMMAND_WORDS = COMMAND_DETAILS.stream()
            .collect(Collectors.toUnmodifiableMap(CommandDetails::getFullCommandWord, entry -> entry));
